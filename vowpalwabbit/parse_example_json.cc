...
template <bool audit>
inline void read_line_json_internal(
    vw& all, v_array<example*>& examples, char* line, VW::example_factory_t example_factory, void* ex_factory_context)
{
...
template <bool audit>
inline void read_line_decision_service_json_internal(vw& all, v_array<example*>& examples, char* line, size_t length, bool copy_line,
...
namespace VW { namespace JSON_PARSER {

void read_line_json_internal(
    vw& all, v_array<example*>& examples, char* line, example_factory_t example_factory, void* ex_factory_context)
{
    ::read_line_json_internal<false>(all, examples, line, example_factory, ex_factory_context);
}

void read_line_json_internal_audit(
    vw& all, v_array<example*>& examples, char* line, example_factory_t example_factory, void* ex_factory_context)
{
    ::read_line_json_internal<true>(all, examples, line, example_factory, ex_factory_context);
}
...
{
    ::read_line_decision_service_json_internal<false>(all, examples, line, length, copy_line, example_factory, ex_factory_context, data);
}
...
void read_line_decision_service_json_internal_audit(vw& all, v_array<example*>& examples, char* line, size_t length, bool copy_line,
    example_factory_t example_factory, void* ex_factory_context, DecisionServiceInteraction* data)
{
    ::read_line_decision_service_json_internal<true>(all, examples, line, length, copy_line, example_factory, ex_factory_context, data);
}
